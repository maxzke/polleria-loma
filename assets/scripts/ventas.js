...
**********************************************************************************************
*/
//Imprime ticket de la ultima venta
const print_last_ticket = document.getElementById('print_last_ticket');
//Clientes existentes
		...
		if(pedido.producto == 'procesado'){
			...
			carrito_table.innerHTML += `
				<tr>
					...
					<td class="text-center"><h5>${pedido.producto}</h5></td>
					<td class="text-center"><h5>${pedido.kilos}</h5></td>
					<td class="text-center"><h5>${pedido.precio}</h5></td>
					<td class="text-center"><h5>${pedido.importe}</h5></td>
					<td>
						<button type="button" class="ml-3 btn btn-sm btn-danger borrar-item"
							data-codigo="${pedido.codigo}">
							<i class="far fa-trash-alt borrar-item"></i>
						</button>
						<button type="button" class="ml-3 btn btn-sm btn-warning editar-item-procesado"
							data-codigo="${pedido.codigo}">
							<i class="fas fa-edit editar-item-procesado"></i>
						</button>
...
print_last_ticket.addEventListener('click', () =>{
	console.log('imprimiendo ultimo ticket');
});