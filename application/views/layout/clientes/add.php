                    ...
                    <div class="col-md-8 mx-auto bg-white">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="box-title"><strong>AGREGAR NUEVO CLIENTE</strong></h3>
                            </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="nombre" value="<?php echo $this->input->post('nombre'); ?>" class="form-control text-capitalize" id="nombre" />
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="number" name="telefono" value="<?php echo $this->input->post('telefono'); ?>" class="form-control" id="telefono" />
