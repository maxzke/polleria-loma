...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <h5 class="text-dark mt-1">REPORTE DE VENTAS <?php echo $fecha; ?></h5>
        <input type="hidden" id="fechareporte" value="<?php echo $fecha; ?>">
      </li>      
      <li>
          <form method="get"accept-charset="utf-8" action="<?php echo base_url('reportes'); ?>">
            <div class="input-group input-group-sm ml-5 mt-1 ">
                ...
                <span class="input-group-btn">
                  <button id="btnGenera" type="submit" class="btn btn-success btn-sm">Generar Reporte</button>
                </span>          
            </div>
          </form>
      </li>
