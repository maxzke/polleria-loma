...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
        <img src="<?php echo base_url()?>/assets/AdminLTE3/dist/img/logo.png" alt="AdminLTE Logo"
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="<?php echo base_url()?>/assets/AdminLTE3/dist/img/user.png" class="img-circle elevation-2"
                    alt="User Image">
            </div>
            <div class="info">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url('EditarVentas')?>" class="nav-link">
                        <i class="nav-icon far fa-edit text-success"></i>
                        <p>Ventas</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url('ventas/saldos_atrasados')?>" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url('gastos_diarios')?>" class="nav-link">
                        <i class="nav-icon fas fa-comments-dollar text-danger"></i>
                        <p>Gastos diarios</p>
                    </a>
                </li>
                <li class="nav-item">
